...
for k in range(30):
    ...
    # if noise2 > 21:
    #     if noise2 != 25 and noise2 != 24:
    #         noise_img2 = cv2.imread("noise-images/"+str(noise2)+".jpeg")
    #     else:
    #         noise_img2 = cv2.imread("noise-images/"+str(noise2)+".jpg")
    # else:
    #     noise_img2 = cv2.imread("noise-images/"+str(noise2)+".jpg")

    # resized_noise_img1 = resize(noise_img1, width, height)
    # resized_noise_img2 = resize(noise_img2, width, height)

    # if k > 30:
    #     final_noise = addNoiseImage(resized_noise_img1, resized_noise_img2)
    # else:
    #     noise_img1 = cv2.imread("noise-images/"+str(k+1)+".jpg")
    #     final_noise = resize(noise_img1, width, height)
